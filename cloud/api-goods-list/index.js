    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                search = new RegExp(event.title.replace(/\s+/g, ""), 'g');
