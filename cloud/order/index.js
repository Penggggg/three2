...
exports.main = function (event, context) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        app.router('pay-last', function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
            var openid, _a, tid_2, integral, orders, coupons, user$, trip$, req, _b, cashcoupon_atleast, cashcoupon_values, temp, e_9;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 5:
                        ...
                        if (!(!!cashcoupon_values && integral >= cashcoupon_values)) return [3, 7];
                        return [4, cloud.callFunction({
                                data: {
                                    data: temp,
                                    $url: 'create'
