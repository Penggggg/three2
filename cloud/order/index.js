                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        list = find$.map(function (x) {
                            var _a = x.data[0], _id = _a._id, tid = _a.tid, pid = _a.pid, sid = _a.sid;
                            return {
                                oid: _id,
                                tid: tid, pid: pid, sid: sid
                            };
                        });
                        return [4, cloud.callFunction({
                                name: 'shopping-list',
