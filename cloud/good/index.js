                ...
                switch (_b.label) {
                    case 0:
                        ...
                        where$ = {
                            ...
                            visiable: true,
                            isDelete: _.neq(true),
                            _id: _.nor(filterGoodIds.map(function (x) { return _.eq(x); }))
                        };
                        return [4, db.collection('app-config')
                                .where({
                                type: 'app-bjp-visible'
