                ...
                switch (_b.label) {
                    ...
                    case 7:
                        ...
                        data = data$.map(function (shopping, k) {
                            return __assign({}, shopping, { detail: good$_1[k] });
                        });
                        _b.label = 8;
                    case 8:
                    ...
                    case 9:
                        ...
                        data = data.map(function (shopping, k) {
                            return __assign({}, shopping, { users: shopping.uids.map(function (uid) { return users$_1.find(function (x) { return x.openid === uid; }); }) });
                        });
                        _b.label = 10;
                    case 10:
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 4:
                                            ...
                                            _a.label = 5;
                                        case 5: return [2, __assign({ count: count }, shopping, { isPin: groupMenOrders$.total > 0, detail: __assign({}, good$.data, { img: standard ? standard.img : good$.data.img[0], name: standard ? standard.name : '' }) })];
                                    }
                                });
                            }); }))];
                    case 3:
