...
Page({
    ...
    onLoad: function (options) {
        ...
        var id = options.id || scene || '6cd397ca5ce7f53f04b9c9367ffe8482';
        this.runComputed();
        this.initCoverText();
        if (!!id) {
            this.setData({
